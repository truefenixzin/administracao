...
<body>
 ...
 <section id="hero" class="values">
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="clients-slider swiper">
            <div class="swiper-wrapper align-items-center">
              <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/avon.jpg')}}" class="img-fluid" alt=""></div>
              <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/riachuelo.png')}}" class="img-fluid" alt=""></div>
              <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/esbelty.png')}}" class="img-fluid" alt=""></div>
              <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/hotpoint.jpg')}}" class="img-fluid" alt=""></div>
              <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/jbcred.png')}}" class="img-fluid" alt=""></div>
              <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/finamax.png')}}" class="img-fluid" alt=""></div>
              <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/newlife.png')}}" class="img-fluid" alt=""></div>
              <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/prolife.png')}}" class="img-fluid" alt=""></div>
            </div>
            <div class="swiper-pagination"></div>
          </div>
        </div>
    ...
    <footer id="footer" class="footer">
        ...
        <div class="container">
          <div class="row gy-4">
            ...
            <div class="col-lg-2 col-6 footer-links">
              <h4>Links uteis</h4>
              <ul>
                <li><i class="bi bi-chevron-right"></i> <a href="http://192.168.0.15/Nectar/" target="_blank">Nectar (CRM</a></li>
      ...
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong><span><a href="https://santosrsystems.com.br/" target="_blank">Santos R Systems</a></span></strong>. All Rights Reserved
        </div>
        <div class="credits">
