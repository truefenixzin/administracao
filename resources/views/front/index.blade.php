        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="clients-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/avon.jpg')}}"
                                                   class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/riachuelo.png')}}"
                                                   class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/esbelty.png')}}"
                                                   class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/hotpoint.jpg')}}"
                                                   class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/jbcred.png')}}"
                                                   class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/finamax.png')}}"
                                                   class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/newlife.png')}}"
                                                   class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="{{asset('new_front/assets/img/credores/prolife.png')}}"
                                                   class="img-fluid" alt=""></div>
                </div>
                <div class="swiper-pagination"></div>
            </div>
        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-lg-2 col-6 footer-links">
                    <h4>Links uteis</h4>
                    <ul>
                        <li><i class="bi bi-chevron-right"></i> <a href="http://192.168.0.15/Nectar/" target="_blank">Nectar
                                (CRM</a></li>
                        <li><i class="bi bi-chevron-right"></i> <a href="http://192.168.0.29/hesk/admin/"
                                                                   target="_blank">Hesk (Chamados)</a></li>
                        <li><i class="bi bi-chevron-right"></i> <a href="https://centraldofuncionario.com.br/29713"
                                                                   target="_blank">Ponto</a></li>
                        <li><i class="bi bi-chevron-right"></i> <a
                                href="https://buscacepinter.correios.com.br/app/endereco/index.php" target="_blank">Busca
                                CEP (Correios)</a></li>
                        <li><i class="bi bi-chevron-right"></i> <a
                                href="https://www.parceleja.cappta.com.br/Identity/Account/Login" target="_blank">PARCELE
                                JÁ</a></li>
                ...
                <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
                    ...
                    <ul>
                        ...
                        <li>FINAMAX - Acessos: FINAMAX Login: FINAMAXPHERFIL (Maiúsculo) Senha: 1Finamaxpherfil@ (F
                            maiúsculo)
                        </li>
